...
export const languageOptions = [
  ...
  { value: 'portuguese', label: 'Brazil (pt-BR)' },
  { value: 'spanish', label: 'Colombia (es-CO)' },
]
...
export const timezoneOptions = timezoneOptionsAsNumber.map(
  ({ value, label }) => {
    return {
